    ...
    render() {
        return (
            <div style={{display: 'flex', flexDirection: 'column', alignItems:'center'}}>
              ...
              <button style={{width: 300, height: 50, backgroundColor: '#282c34', marginTop: 28}}><Link style ={{textDecoration: 'none', height: 100, fontSize:35, fontWeight:'bold'}} to="/user/createAccount">Create Account</Link></button>
            </div>
        )
    }
}
